...
var compareChunk = require('./compare.js'),
    getObjValue = require('enterprise-utils').object.deepGet,
 ...
 * @param {Function} destRead function(iteration, cb) - cb(data) SORTED BY keyName!
...
module.exports = function synchronize(opts, done){
    ...
    function sync(i){
        setImmediate(function(){
            readChunk(i, function(sourceItems, destItems){
